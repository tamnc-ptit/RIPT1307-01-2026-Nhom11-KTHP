...
const MOCK_TASKS: Milestone[] = [
  {
    ...
    thesis_id: 1,
    created_by: 1,
    title: 'Hoàn thiện tài liệu đặc tả',
    description: 'Viết xong SRS và chốt với mentor',
    deadline: '20/05/2026',
  ...
  },
  {
    ...
    thesis_id: 1,
    created_by: 1,
    title: 'Thiết kế Database ERD',
    description: 'Hoàn thiện các bảng dữ liệu cho hệ thống',
    deadline: '25/05/2026',
...
const TaskCard: React.FC<{
  ...
  const handleConfirmUpdate = () => {
    const newStatus: MilestoneStatus =
      editProgress === 100 ? 'completed' : 'pending';
    ...
    form
      ...
      .then((values) => {
        const formattedDeadline = values.deadline
          ? values.deadline.format('DD/MM/YYYY')
          : '';
    ...
    >
      ...
      >
        ...
        <Space wrap>
          ...
          {overdueCount > 0 && (
            <Tag color="error">{overdueCount} quá hạn</Tag>
          )}
      ...
      <List
        ...
        dataSource={todos}
        locale={{
          emptyText: 'Chưa có ghi chú nào được thêm.',
        }}
        renderItem={(item) => (
          <List.Item
            style={{
      ...
      <Modal
        ...
        title={
          <Space>
            ...
            <Text strong>Thêm công việc mới</Text>
          </Space>
        }
      >
        <Form
...
const Progress: React.FC = () => {
      ...
      try {
        ...
        if (USE_MOCK_API) {
          ...
          const res = await request(
            '/api/student/theses/1/milestones',
            {
              method: 'GET',
            },
          );
  ...
  return (
    <Spin
      spinning={loadingInitial}
      tip="Đang tải lộ trình..."
    >
      <div
        style={{
          minHeight: '100vh',
